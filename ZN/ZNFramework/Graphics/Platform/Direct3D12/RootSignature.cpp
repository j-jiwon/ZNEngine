...
void RootSignature::CreateRootSignature()
{
	...
	CD3DX12_DESCRIPTOR_RANGE ranges[] =
	{
		...
		CD3DX12_DESCRIPTOR_RANGE(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, SRV_REGISTER_COUNT + GLOBAL_SRV_COUNT, 0), // t0~t9 (shadow map, env cube, IBL irradiance/prefiltered/BRDF LUT)
	};
